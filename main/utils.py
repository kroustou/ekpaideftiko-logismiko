from models import Exercise, Mistakes, Student, Test, Examination, Grade
...
def evaluate_exam(exam_pk, answers, type, student):
    ...
    newGrade = Grade(student=student, exam=exam, takenOn=datetime.now(), grade=grade)
